<template>
  <div class="p-1 p-md-3 my-1 mx-0 mb-2 mb-lg-3 d-flex flex-row align-items-center justify-content-center"
    ...
    <i class="mdi fs-1"
      :class="props.icon, props.leftAlignedIcon ? 'order-1 pe-3' : 'order-2 ps-3', props.themeStyle ? 'theme-text' : ''"
      :style="[props.themeStyle ? { 'color': '#F2FAC4' } : { 'color': props.color }]"></i>

    <div class="d-flex flex-column justify-content-center"
      :class="props.leftAlignedIcon ? 'order-2' : 'order-1 text-center fs-4'">
