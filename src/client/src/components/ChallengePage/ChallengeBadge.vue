<template>
  <div :title="badge?.title || challenge?.name" class="col-3 badge badge-color position-relative mt-3" id="collaborator">
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" width="130px" height="140px"
      viewBox="0 0 216 232">
      <defs>
      ...
      <path
        d="M207,0C171.827,0.001,43.875,0.004,9.003,0c-5.619-0.001-9,3.514-9,0c0,28.23-0.006,51.375,0,159c0.005,19.875,115.499,54,107.999,54S216,179,216,159V9C216,3.298,212.732,0,207,0z"
        stroke-width="50" stroke="url(#badgeGradient)" />
